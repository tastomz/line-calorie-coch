...
CREATE TABLE "MembershipLinkToken" (
    ...
    CONSTRAINT "MembershipLinkToken_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "MembershipLinkToken" ADD CONSTRAINT "MembershipLinkToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
